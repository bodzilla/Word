    ...
    namespace Fasetto.Word
    {
        ...
        public class WindowResizer
        {
            ...
            private void GetTransform()
            {
                ...
                if (source?.CompositionTarget != null) _transformToDevice = source.CompositionTarget.TransformToDevice;
            }
            ...
            private void Window_SizeChanged(object sender, SizeChangedEventArgs e)
            {
                ...
                // Left docking
                if (edgedTop && edgedBottom && edgedLeft) dock = WindowDockPosition.Left;
                else if (edgedTop && edgedBottom && edgedRight) dock = WindowDockPosition.Right;
                // None
                else dock = WindowDockPosition.Undocked;

                // If dock has changed, inform listeners
            ...
            private void WmGetMinMaxInfo(IntPtr lParam)
            {
                ...
                if (lCurrentScreen != _lastScreen || _transformToDevice == default(Matrix)) GetTransform();
